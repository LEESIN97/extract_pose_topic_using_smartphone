...
declare module 'rclnodejs' {
  ...
  namespace ds4_driver_msgs {
    namespace msg {
      export interface Feedback {
        ...
        led_flash_on: number;
        led_flash_off: number;
        set_rumble: boolean;
        rumble_duration: number;
        rumble_small: number;
        rumble_big: number;
      }
      export interface FeedbackConstructor {
        new(other?: Feedback): Feedback;
      }
      export interface Report {
        header: std_msgs.msg.Header;
        left_analog_x: number;
        left_analog_y: number;
        right_analog_x: number;
        right_analog_y: number;
        l2_analog: number;
        r2_analog: number;
        dpad_up: boolean;
        dpad_down: boolean;
        ...
        ang_vel_y: number;
        ang_vel_z: number;
        trackpad_touch0_id: number;
        trackpad_touch0_active: number;
        trackpad_touch0_x: number;
        trackpad_touch0_y: number;
        trackpad_touch1_id: number;
        trackpad_touch1_active: number;
        trackpad_touch1_x: number;
        trackpad_touch1_y: number;
        timestamp: number;
        battery: number;
        plug_usb: boolean;
        plug_audio: boolean;
      ...
      export interface Status {
        ...
        button_r3: number;
        button_share: number;
        button_options: number;
        button_trackpad: number;
        button_ps: number;
        imu: sensor_msgs.msg.Imu;
        battery_percentage: number;
        battery_full_charging: number;
        touch0: ds4_driver_msgs.msg.Trackpad;
        touch1: ds4_driver_msgs.msg.Trackpad;
        plug_usb: number;
        plug_audio: number;
        plug_mic: number;
      }
      ...
      export interface TrackpadConstructor {
        new(other?: Trackpad): Trackpad;
      }
    }
  }
  ...
  namespace gazebo_model_attachment_plugin_msgs {
    namespace srv {
      export interface AttachConstructor extends ROSService {
        readonly Request: Attach_RequestConstructor;
        readonly Response: Attach_ResponseConstructor;
      }
      export interface Attach_Request {
        joint_name: string;
        model_name_1: string;
        link_name_1: string;
        model_name_2: string;
      ...
      export interface Attach_RequestConstructor {
        new(other?: Attach_Request): Attach_Request;
      }
      export interface Attach_Response {
        success: boolean;
        message: string;
      }
      export interface Attach_ResponseConstructor {
        new(other?: Attach_Response): Attach_Response;
      }
      export interface DetachConstructor extends ROSService {
        readonly Request: Detach_RequestConstructor;
        readonly Response: Detach_ResponseConstructor;
      }
      export interface Detach_Request {
        joint_name: string;
        model_name_1: string;
        model_name_2: string;
      }
      export interface Detach_RequestConstructor {
        new(other?: Detach_Request): Detach_Request;
      }
      export interface Detach_Response {
        success: boolean;
        message: string;
      }
      export interface Detach_ResponseConstructor {
        new(other?: Detach_Response): Detach_Response;
      }
    }
  }
  ...
  namespace gazebo_msgs {
    namespace msg {
      ...
      export interface WheelSlip {
        name: string[];
        lateral_slip: number[] | Float64Array;
        longitudinal_slip: number[] | Float64Array;
      }
      export interface WheelSlipConstructor {
        new(other?: WheelSlip): WheelSlip;
      }
  ...
  namespace gazebo_video_monitor_interfaces {
    namespace msg {
    ...
    namespace srv {
      export interface SetCameraConstructor extends ROSService {
        readonly Request: SetCamera_RequestConstructor;
        readonly Response: SetCamera_ResponseConstructor;
      }
      export interface SetCamera_Request {
        camera_name: string;
        model_name: string;
        link_name: string;
        pose: gazebo_video_monitor_interfaces.msg.Pose;
      }
      export interface SetCamera_RequestConstructor {
        new(other?: SetCamera_Request): SetCamera_Request;
      }
      export interface SetCamera_Response {
        message: string;
        success: boolean;
      }
      export interface SetCamera_ResponseConstructor {
        new(other?: SetCamera_Response): SetCamera_Response;
      }
      export interface StartGmcmRecordingConstructor extends ROSService {
        readonly Request: StartGmcmRecording_RequestConstructor;
        readonly Response: StartGmcmRecording_ResponseConstructor;
      }
      export interface StartGmcmRecording_Request {
        cameras: gazebo_video_monitor_interfaces.msg.Strings;
      }
      export interface StartGmcmRecording_RequestConstructor {
        new(other?: StartGmcmRecording_Request): StartGmcmRecording_Request;
      }
      export interface StartGmcmRecording_Response {
      }
      export interface StartGmcmRecording_ResponseConstructor {
        new(other?: StartGmcmRecording_Response): StartGmcmRecording_Response;
      }
      export interface StartGvmRecordingConstructor extends ROSService {
        readonly Request: StartGvmRecording_RequestConstructor;
        readonly Response: StartGvmRecording_ResponseConstructor;
      }
      export interface StartGvmRecording_Request {
        disable_window: boolean;
        world_as_main_view: boolean;
      }
      export interface StartGvmRecording_RequestConstructor {
        new(other?: StartGvmRecording_Request): StartGvmRecording_Request;
      }
      export interface StartGvmRecording_Response {
      }
      export interface StartGvmRecording_ResponseConstructor {
        new(other?: StartGvmRecording_Response): StartGvmRecording_Response;
      }
      export interface StopRecordingConstructor extends ROSService {
        readonly Request: StopRecording_RequestConstructor;
        readonly Response: StopRecording_ResponseConstructor;
      }
      export interface StopRecording_Request {
        discard: boolean;
        filename: string;
      }
      export interface StopRecording_RequestConstructor {
        new(other?: StopRecording_Request): StopRecording_Request;
      }
      export interface StopRecording_Response {
        path: string;
        success: boolean;
      }
      export interface StopRecording_ResponseConstructor {
        new(other?: StopRecording_Response): StopRecording_Response;
      }
    }
  }
  ...
  namespace gps_msgs {
    namespace msg {
      ...
      export interface GPSStatusConstructor {
        ...
        readonly STATUS_RTK_FIX: number;
        readonly STATUS_RTK_FLOAT: number;
  ...
  namespace orbbec_camera_msgs {
    namespace msg {
      ...
      export interface DeviceInfoConstructor {
        new(other?: DeviceInfo): DeviceInfo;
      }
      ...
      export interface IMUInfo {
        ...
        bias: number[] | Float64Array;
        gravity: number[] | Float64Array;
        scale_misalignment: number[] | Float64Array;
        temperature_slope: number[] | Float64Array;
      }
    ...
    namespace srv {
      export interface GetBoolConstructor extends ROSService {
        readonly Request: GetBool_RequestConstructor;
        readonly Response: GetBool_ResponseConstructor;
      }
      export interface GetBool_Request {
      }
      export interface GetBool_RequestConstructor {
        new(other?: GetBool_Request): GetBool_Request;
      }
      export interface GetBool_Response {
        data: boolean;
        success: boolean;
        message: string;
      }
      export interface GetBool_ResponseConstructor {
        new(other?: GetBool_Response): GetBool_Response;
      }
      export interface GetCameraInfoConstructor extends ROSService {
        readonly Request: GetCameraInfo_RequestConstructor;
        readonly Response: GetCameraInfo_ResponseConstructor;
      }
      export interface GetCameraInfo_Request {
      }
      export interface GetCameraInfo_RequestConstructor {
        new(other?: GetCameraInfo_Request): GetCameraInfo_Request;
      }
      export interface GetCameraInfo_Response {
        info: sensor_msgs.msg.CameraInfo;
      }
      export interface GetCameraInfo_ResponseConstructor {
        new(other?: GetCameraInfo_Response): GetCameraInfo_Response;
      }
      export interface GetDeviceInfoConstructor extends ROSService {
        readonly Request: GetDeviceInfo_RequestConstructor;
        readonly Response: GetDeviceInfo_ResponseConstructor;
      }
      export interface GetDeviceInfo_Request {
      }
      export interface GetDeviceInfo_RequestConstructor {
        new(other?: GetDeviceInfo_Request): GetDeviceInfo_Request;
      }
      export interface GetDeviceInfo_Response {
        info: orbbec_camera_msgs.msg.DeviceInfo;
        success: boolean;
        message: string;
      }
      export interface GetDeviceInfo_ResponseConstructor {
        new(other?: GetDeviceInfo_Response): GetDeviceInfo_Response;
      }
      export interface GetInt32Constructor extends ROSService {
        readonly Request: GetInt32_RequestConstructor;
        readonly Response: GetInt32_ResponseConstructor;
      }
      export interface GetInt32_Request {
      }
      export interface GetInt32_RequestConstructor {
        new(other?: GetInt32_Request): GetInt32_Request;
      }
      export interface GetInt32_Response {
        data: number;
        success: boolean;
        message: string;
      }
      export interface GetInt32_ResponseConstructor {
        new(other?: GetInt32_Response): GetInt32_Response;
      }
      export interface GetStringConstructor extends ROSService {
        readonly Request: GetString_RequestConstructor;
        readonly Response: GetString_ResponseConstructor;
      }
      export interface GetString_Request {
      }
      export interface GetString_RequestConstructor {
        new(other?: GetString_Request): GetString_Request;
      }
      export interface GetString_Response {
        data: string;
        success: boolean;
        message: string;
      }
      export interface GetString_ResponseConstructor {
        new(other?: GetString_Response): GetString_Response;
      }
      export interface SetInt32Constructor extends ROSService {
        readonly Request: SetInt32_RequestConstructor;
        readonly Response: SetInt32_ResponseConstructor;
      }
      export interface SetInt32_Request {
        data: number;
      }
      export interface SetInt32_RequestConstructor {
        new(other?: SetInt32_Request): SetInt32_Request;
      }
      export interface SetInt32_Response {
        success: boolean;
        message: string;
      }
      export interface SetInt32_ResponseConstructor {
        new(other?: SetInt32_Response): SetInt32_Response;
      }
      export interface SetStringConstructor extends ROSService {
        readonly Request: SetString_RequestConstructor;
        readonly Response: SetString_ResponseConstructor;
      }
      export interface SetString_Request {
        data: string;
      }
      export interface SetString_RequestConstructor {
        new(other?: SetString_Request): SetString_Request;
      }
      export interface SetString_Response {
        success: boolean;
        message: string;
      }
      export interface SetString_ResponseConstructor {
        new(other?: SetString_Response): SetString_Response;
      }
    }
  }
  ...
  namespace realsense2_camera_msgs {
    namespace action {
      export interface TriggeredCalibrationConstructor {
        readonly Goal: TriggeredCalibration_GoalConstructor;
        readonly Result: TriggeredCalibration_ResultConstructor;
        readonly Feedback: TriggeredCalibration_FeedbackConstructor;
      }
      export interface TriggeredCalibration_Feedback {
        progress: number;
      }
      export interface TriggeredCalibration_FeedbackConstructor {
        new(other?: TriggeredCalibration_Feedback): TriggeredCalibration_Feedback;
      }
      export interface TriggeredCalibration_FeedbackMessage {
        goal_id: unique_identifier_msgs.msg.UUID;
        feedback: realsense2_camera_msgs.action.TriggeredCalibration_Feedback;
      }
      export interface TriggeredCalibration_FeedbackMessageConstructor {
        new(other?: TriggeredCalibration_FeedbackMessage): TriggeredCalibration_FeedbackMessage;
      }
      export interface TriggeredCalibration_GetResultConstructor extends ROSService {
        readonly Request: TriggeredCalibration_GetResult_RequestConstructor;
        readonly Response: TriggeredCalibration_GetResult_ResponseConstructor;
      }
      export interface TriggeredCalibration_GetResult_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
      }
      export interface TriggeredCalibration_GetResult_RequestConstructor {
        new(other?: TriggeredCalibration_GetResult_Request): TriggeredCalibration_GetResult_Request;
      }
      export interface TriggeredCalibration_GetResult_Response {
        status: number;
        result: realsense2_camera_msgs.action.TriggeredCalibration_Result;
      }
      export interface TriggeredCalibration_GetResult_ResponseConstructor {
        new(other?: TriggeredCalibration_GetResult_Response): TriggeredCalibration_GetResult_Response;
      }
      export interface TriggeredCalibration_Goal {
        json: string;
      }
      export interface TriggeredCalibration_GoalConstructor {
        new(other?: TriggeredCalibration_Goal): TriggeredCalibration_Goal;
      }
      export interface TriggeredCalibration_Result {
        success: boolean;
        error_msg: string;
        calibration: string;
        health: number;
      }
      export interface TriggeredCalibration_ResultConstructor {
        new(other?: TriggeredCalibration_Result): TriggeredCalibration_Result;
      }
      export interface TriggeredCalibration_SendGoalConstructor extends ROSService {
        readonly Request: TriggeredCalibration_SendGoal_RequestConstructor;
        readonly Response: TriggeredCalibration_SendGoal_ResponseConstructor;
      }
      export interface TriggeredCalibration_SendGoal_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
        goal: realsense2_camera_msgs.action.TriggeredCalibration_Goal;
      }
      export interface TriggeredCalibration_SendGoal_RequestConstructor {
        new(other?: TriggeredCalibration_SendGoal_Request): TriggeredCalibration_SendGoal_Request;
      }
      export interface TriggeredCalibration_SendGoal_Response {
        accepted: boolean;
        stamp: builtin_interfaces.msg.Time;
      }
      export interface TriggeredCalibration_SendGoal_ResponseConstructor {
        new(other?: TriggeredCalibration_SendGoal_Response): TriggeredCalibration_SendGoal_Response;
      }
    }
    namespace msg {
      export interface Extrinsics {
    ...
    namespace srv {
      export interface CalibConfigReadConstructor extends ROSService {
        readonly Request: CalibConfigRead_RequestConstructor;
        readonly Response: CalibConfigRead_ResponseConstructor;
      }
      export interface CalibConfigRead_Request {
      }
      export interface CalibConfigRead_RequestConstructor {
        new(other?: CalibConfigRead_Request): CalibConfigRead_Request;
      }
      export interface CalibConfigRead_Response {
        success: boolean;
        error_message: string;
        calib_config: string;
      }
      export interface CalibConfigRead_ResponseConstructor {
        new(other?: CalibConfigRead_Response): CalibConfigRead_Response;
      }
      export interface CalibConfigWriteConstructor extends ROSService {
        readonly Request: CalibConfigWrite_RequestConstructor;
        readonly Response: CalibConfigWrite_ResponseConstructor;
      }
      export interface CalibConfigWrite_Request {
        calib_config: string;
      }
      export interface CalibConfigWrite_RequestConstructor {
        new(other?: CalibConfigWrite_Request): CalibConfigWrite_Request;
      }
      export interface CalibConfigWrite_Response {
        success: boolean;
        error_message: string;
      }
      export interface CalibConfigWrite_ResponseConstructor {
        new(other?: CalibConfigWrite_Response): CalibConfigWrite_Response;
      }
  ...
  namespace ros_gz_interfaces {
    namespace msg {
      ...
      export interface EntityWrench {
        header: std_msgs.msg.Header;
        entity: ros_gz_interfaces.msg.Entity;
        wrench: geometry_msgs.msg.Wrench;
      }
      export interface EntityWrenchConstructor {
        new(other?: EntityWrench): EntityWrench;
      }
  ...
  namespace turtlebot3_msgs {
    namespace action {
      ...
      export interface Patrol_Goal {
        goal: geometry_msgs.msg.Vector3;
      }
    ...
    namespace srv {
      ...
      export interface GoalConstructor extends ROSService {
        readonly Request: Goal_RequestConstructor;
        readonly Response: Goal_ResponseConstructor;
      }
      export interface Goal_Request {
      }
      export interface Goal_RequestConstructor {
        new(other?: Goal_Request): Goal_Request;
      }
      export interface Goal_Response {
        pose_x: number;
        pose_y: number;
        success: boolean;
      }
      export interface Goal_ResponseConstructor {
        new(other?: Goal_Response): Goal_Response;
      }
  ...
  namespace twist_mux_msgs {
    namespace action {
      export interface JoyPriorityConstructor {
        readonly Goal: JoyPriority_GoalConstructor;
        readonly Result: JoyPriority_ResultConstructor;
        readonly Feedback: JoyPriority_FeedbackConstructor;
      }
      export interface JoyPriority_Feedback {
      }
      export interface JoyPriority_FeedbackConstructor {
        new(other?: JoyPriority_Feedback): JoyPriority_Feedback;
      }
      export interface JoyPriority_FeedbackMessage {
        goal_id: unique_identifier_msgs.msg.UUID;
        feedback: twist_mux_msgs.action.JoyPriority_Feedback;
      }
      export interface JoyPriority_FeedbackMessageConstructor {
        new(other?: JoyPriority_FeedbackMessage): JoyPriority_FeedbackMessage;
      }
      export interface JoyPriority_GetResultConstructor extends ROSService {
        readonly Request: JoyPriority_GetResult_RequestConstructor;
        readonly Response: JoyPriority_GetResult_ResponseConstructor;
      }
      export interface JoyPriority_GetResult_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
      }
      export interface JoyPriority_GetResult_RequestConstructor {
        new(other?: JoyPriority_GetResult_Request): JoyPriority_GetResult_Request;
      }
      export interface JoyPriority_GetResult_Response {
        status: number;
        result: twist_mux_msgs.action.JoyPriority_Result;
      }
      export interface JoyPriority_GetResult_ResponseConstructor {
        new(other?: JoyPriority_GetResult_Response): JoyPriority_GetResult_Response;
      }
      export interface JoyPriority_Goal {
      }
      export interface JoyPriority_GoalConstructor {
        new(other?: JoyPriority_Goal): JoyPriority_Goal;
      }
      export interface JoyPriority_Result {
      }
      export interface JoyPriority_ResultConstructor {
        new(other?: JoyPriority_Result): JoyPriority_Result;
      }
      export interface JoyPriority_SendGoalConstructor extends ROSService {
        readonly Request: JoyPriority_SendGoal_RequestConstructor;
        readonly Response: JoyPriority_SendGoal_ResponseConstructor;
      }
      export interface JoyPriority_SendGoal_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
        goal: twist_mux_msgs.action.JoyPriority_Goal;
      }
      export interface JoyPriority_SendGoal_RequestConstructor {
        new(other?: JoyPriority_SendGoal_Request): JoyPriority_SendGoal_Request;
      }
      export interface JoyPriority_SendGoal_Response {
        accepted: boolean;
        stamp: builtin_interfaces.msg.Time;
      }
      export interface JoyPriority_SendGoal_ResponseConstructor {
        new(other?: JoyPriority_SendGoal_Response): JoyPriority_SendGoal_Response;
      }
      export interface JoyTurboConstructor {
        readonly Goal: JoyTurbo_GoalConstructor;
        readonly Result: JoyTurbo_ResultConstructor;
        readonly Feedback: JoyTurbo_FeedbackConstructor;
      }
      export interface JoyTurbo_Feedback {
      }
      export interface JoyTurbo_FeedbackConstructor {
        new(other?: JoyTurbo_Feedback): JoyTurbo_Feedback;
      }
      export interface JoyTurbo_FeedbackMessage {
        goal_id: unique_identifier_msgs.msg.UUID;
        feedback: twist_mux_msgs.action.JoyTurbo_Feedback;
      }
      export interface JoyTurbo_FeedbackMessageConstructor {
        new(other?: JoyTurbo_FeedbackMessage): JoyTurbo_FeedbackMessage;
      }
      export interface JoyTurbo_GetResultConstructor extends ROSService {
        readonly Request: JoyTurbo_GetResult_RequestConstructor;
        readonly Response: JoyTurbo_GetResult_ResponseConstructor;
      }
      export interface JoyTurbo_GetResult_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
      }
      export interface JoyTurbo_GetResult_RequestConstructor {
        new(other?: JoyTurbo_GetResult_Request): JoyTurbo_GetResult_Request;
      }
      export interface JoyTurbo_GetResult_Response {
        status: number;
        result: twist_mux_msgs.action.JoyTurbo_Result;
      }
      export interface JoyTurbo_GetResult_ResponseConstructor {
        new(other?: JoyTurbo_GetResult_Response): JoyTurbo_GetResult_Response;
      }
      export interface JoyTurbo_Goal {
      }
      export interface JoyTurbo_GoalConstructor {
        new(other?: JoyTurbo_Goal): JoyTurbo_Goal;
      }
      export interface JoyTurbo_Result {
      }
      export interface JoyTurbo_ResultConstructor {
        new(other?: JoyTurbo_Result): JoyTurbo_Result;
      }
      export interface JoyTurbo_SendGoalConstructor extends ROSService {
        readonly Request: JoyTurbo_SendGoal_RequestConstructor;
        readonly Response: JoyTurbo_SendGoal_ResponseConstructor;
      }
      export interface JoyTurbo_SendGoal_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
        goal: twist_mux_msgs.action.JoyTurbo_Goal;
      }
      export interface JoyTurbo_SendGoal_RequestConstructor {
        new(other?: JoyTurbo_SendGoal_Request): JoyTurbo_SendGoal_Request;
      }
      export interface JoyTurbo_SendGoal_Response {
        accepted: boolean;
        stamp: builtin_interfaces.msg.Time;
      }
      export interface JoyTurbo_SendGoal_ResponseConstructor {
        new(other?: JoyTurbo_SendGoal_Response): JoyTurbo_SendGoal_Response;
      }
    }
  }
  ...
  type MessagesMap = {
    ...
    'ds4_driver_msgs/msg/Feedback': ds4_driver_msgs.msg.Feedback,
    'ds4_driver_msgs/msg/Report': ds4_driver_msgs.msg.Report,
    'ds4_driver_msgs/msg/Status': ds4_driver_msgs.msg.Status,
    'ds4_driver_msgs/msg/Trackpad': ds4_driver_msgs.msg.Trackpad,
    ...
    'gazebo_model_attachment_plugin_msgs/srv/Attach_Request': gazebo_model_attachment_plugin_msgs.srv.Attach_Request,
    'gazebo_model_attachment_plugin_msgs/srv/Attach_Response': gazebo_model_attachment_plugin_msgs.srv.Attach_Response,
    'gazebo_model_attachment_plugin_msgs/srv/Detach_Request': gazebo_model_attachment_plugin_msgs.srv.Detach_Request,
    'gazebo_model_attachment_plugin_msgs/srv/Detach_Response': gazebo_model_attachment_plugin_msgs.srv.Detach_Response,
    ...
    'gazebo_msgs/msg/WheelSlip': gazebo_msgs.msg.WheelSlip,
    ...
    'gazebo_video_monitor_interfaces/msg/Pose': gazebo_video_monitor_interfaces.msg.Pose,
    'gazebo_video_monitor_interfaces/msg/Strings': gazebo_video_monitor_interfaces.msg.Strings,
    'gazebo_video_monitor_interfaces/srv/SetCamera_Request': gazebo_video_monitor_interfaces.srv.SetCamera_Request,
    'gazebo_video_monitor_interfaces/srv/SetCamera_Response': gazebo_video_monitor_interfaces.srv.SetCamera_Response,
    'gazebo_video_monitor_interfaces/srv/StartGmcmRecording_Request': gazebo_video_monitor_interfaces.srv.StartGmcmRecording_Request,
    'gazebo_video_monitor_interfaces/srv/StartGmcmRecording_Response': gazebo_video_monitor_interfaces.srv.StartGmcmRecording_Response,
    'gazebo_video_monitor_interfaces/srv/StartGvmRecording_Request': gazebo_video_monitor_interfaces.srv.StartGvmRecording_Request,
    'gazebo_video_monitor_interfaces/srv/StartGvmRecording_Response': gazebo_video_monitor_interfaces.srv.StartGvmRecording_Response,
    'gazebo_video_monitor_interfaces/srv/StopRecording_Request': gazebo_video_monitor_interfaces.srv.StopRecording_Request,
    'gazebo_video_monitor_interfaces/srv/StopRecording_Response': gazebo_video_monitor_interfaces.srv.StopRecording_Response,
    ...
    'orbbec_camera_msgs/msg/DeviceInfo': orbbec_camera_msgs.msg.DeviceInfo,
    'orbbec_camera_msgs/msg/Extrinsics': orbbec_camera_msgs.msg.Extrinsics,
    'orbbec_camera_msgs/msg/IMUInfo': orbbec_camera_msgs.msg.IMUInfo,
    'orbbec_camera_msgs/msg/Metadata': orbbec_camera_msgs.msg.Metadata,
    'orbbec_camera_msgs/srv/GetBool_Request': orbbec_camera_msgs.srv.GetBool_Request,
    'orbbec_camera_msgs/srv/GetBool_Response': orbbec_camera_msgs.srv.GetBool_Response,
    'orbbec_camera_msgs/srv/GetCameraInfo_Request': orbbec_camera_msgs.srv.GetCameraInfo_Request,
    'orbbec_camera_msgs/srv/GetCameraInfo_Response': orbbec_camera_msgs.srv.GetCameraInfo_Response,
    'orbbec_camera_msgs/srv/GetDeviceInfo_Request': orbbec_camera_msgs.srv.GetDeviceInfo_Request,
    'orbbec_camera_msgs/srv/GetDeviceInfo_Response': orbbec_camera_msgs.srv.GetDeviceInfo_Response,
    'orbbec_camera_msgs/srv/GetInt32_Request': orbbec_camera_msgs.srv.GetInt32_Request,
    'orbbec_camera_msgs/srv/GetInt32_Response': orbbec_camera_msgs.srv.GetInt32_Response,
    'orbbec_camera_msgs/srv/GetString_Request': orbbec_camera_msgs.srv.GetString_Request,
    'orbbec_camera_msgs/srv/GetString_Response': orbbec_camera_msgs.srv.GetString_Response,
    'orbbec_camera_msgs/srv/SetInt32_Request': orbbec_camera_msgs.srv.SetInt32_Request,
    'orbbec_camera_msgs/srv/SetInt32_Response': orbbec_camera_msgs.srv.SetInt32_Response,
    'orbbec_camera_msgs/srv/SetString_Request': orbbec_camera_msgs.srv.SetString_Request,
    'orbbec_camera_msgs/srv/SetString_Response': orbbec_camera_msgs.srv.SetString_Response,
    ...
    'realsense2_camera_msgs/action/TriggeredCalibration_Feedback': realsense2_camera_msgs.action.TriggeredCalibration_Feedback,
    'realsense2_camera_msgs/action/TriggeredCalibration_FeedbackMessage': realsense2_camera_msgs.action.TriggeredCalibration_FeedbackMessage,
    'realsense2_camera_msgs/action/TriggeredCalibration_GetResult_Request': realsense2_camera_msgs.action.TriggeredCalibration_GetResult_Request,
    'realsense2_camera_msgs/action/TriggeredCalibration_GetResult_Response': realsense2_camera_msgs.action.TriggeredCalibration_GetResult_Response,
    'realsense2_camera_msgs/action/TriggeredCalibration_Goal': realsense2_camera_msgs.action.TriggeredCalibration_Goal,
    'realsense2_camera_msgs/action/TriggeredCalibration_Result': realsense2_camera_msgs.action.TriggeredCalibration_Result,
    'realsense2_camera_msgs/action/TriggeredCalibration_SendGoal_Request': realsense2_camera_msgs.action.TriggeredCalibration_SendGoal_Request,
    'realsense2_camera_msgs/action/TriggeredCalibration_SendGoal_Response': realsense2_camera_msgs.action.TriggeredCalibration_SendGoal_Response,
    ...
    'realsense2_camera_msgs/srv/CalibConfigRead_Request': realsense2_camera_msgs.srv.CalibConfigRead_Request,
    'realsense2_camera_msgs/srv/CalibConfigRead_Response': realsense2_camera_msgs.srv.CalibConfigRead_Response,
    'realsense2_camera_msgs/srv/CalibConfigWrite_Request': realsense2_camera_msgs.srv.CalibConfigWrite_Request,
    'realsense2_camera_msgs/srv/CalibConfigWrite_Response': realsense2_camera_msgs.srv.CalibConfigWrite_Response,
    ...
    'ros_gz_interfaces/msg/EntityWrench': ros_gz_interfaces.msg.EntityWrench,
    ...
    'slam_toolbox/srv/AddSubmap_Request': slam_toolbox.srv.AddSubmap_Request,
    'slam_toolbox/srv/AddSubmap_Response': slam_toolbox.srv.AddSubmap_Response,
    'slam_toolbox/srv/ClearQueue_Request': slam_toolbox.srv.ClearQueue_Request,
    'slam_toolbox/srv/ClearQueue_Response': slam_toolbox.srv.ClearQueue_Response,
    'slam_toolbox/srv/Clear_Request': slam_toolbox.srv.Clear_Request,
    'slam_toolbox/srv/Clear_Response': slam_toolbox.srv.Clear_Response,
    'slam_toolbox/srv/DeserializePoseGraph_Request': slam_toolbox.srv.DeserializePoseGraph_Request,
    'slam_toolbox/srv/DeserializePoseGraph_Response': slam_toolbox.srv.DeserializePoseGraph_Response,
    'slam_toolbox/srv/LoopClosure_Request': slam_toolbox.srv.LoopClosure_Request,
    'slam_toolbox/srv/LoopClosure_Response': slam_toolbox.srv.LoopClosure_Response,
    'slam_toolbox/srv/MergeMaps_Request': slam_toolbox.srv.MergeMaps_Request,
    'slam_toolbox/srv/MergeMaps_Response': slam_toolbox.srv.MergeMaps_Response,
    'slam_toolbox/srv/Pause_Request': slam_toolbox.srv.Pause_Request,
    'slam_toolbox/srv/Pause_Response': slam_toolbox.srv.Pause_Response,
    'slam_toolbox/srv/SaveMap_Request': slam_toolbox.srv.SaveMap_Request,
    'slam_toolbox/srv/SaveMap_Response': slam_toolbox.srv.SaveMap_Response,
    'slam_toolbox/srv/SerializePoseGraph_Request': slam_toolbox.srv.SerializePoseGraph_Request,
    'slam_toolbox/srv/SerializePoseGraph_Response': slam_toolbox.srv.SerializePoseGraph_Response,
    'slam_toolbox/srv/ToggleInteractive_Request': slam_toolbox.srv.ToggleInteractive_Request,
    'slam_toolbox/srv/ToggleInteractive_Response': slam_toolbox.srv.ToggleInteractive_Response,
    ...
    'turtlebot3_msgs/srv/Goal_Request': turtlebot3_msgs.srv.Goal_Request,
    'turtlebot3_msgs/srv/Goal_Response': turtlebot3_msgs.srv.Goal_Response,
    ...
    'twist_mux_msgs/action/JoyPriority_Feedback': twist_mux_msgs.action.JoyPriority_Feedback,
    'twist_mux_msgs/action/JoyPriority_FeedbackMessage': twist_mux_msgs.action.JoyPriority_FeedbackMessage,
    'twist_mux_msgs/action/JoyPriority_GetResult_Request': twist_mux_msgs.action.JoyPriority_GetResult_Request,
    'twist_mux_msgs/action/JoyPriority_GetResult_Response': twist_mux_msgs.action.JoyPriority_GetResult_Response,
    'twist_mux_msgs/action/JoyPriority_Goal': twist_mux_msgs.action.JoyPriority_Goal,
    'twist_mux_msgs/action/JoyPriority_Result': twist_mux_msgs.action.JoyPriority_Result,
    'twist_mux_msgs/action/JoyPriority_SendGoal_Request': twist_mux_msgs.action.JoyPriority_SendGoal_Request,
    'twist_mux_msgs/action/JoyPriority_SendGoal_Response': twist_mux_msgs.action.JoyPriority_SendGoal_Response,
    'twist_mux_msgs/action/JoyTurbo_Feedback': twist_mux_msgs.action.JoyTurbo_Feedback,
    'twist_mux_msgs/action/JoyTurbo_FeedbackMessage': twist_mux_msgs.action.JoyTurbo_FeedbackMessage,
    'twist_mux_msgs/action/JoyTurbo_GetResult_Request': twist_mux_msgs.action.JoyTurbo_GetResult_Request,
    'twist_mux_msgs/action/JoyTurbo_GetResult_Response': twist_mux_msgs.action.JoyTurbo_GetResult_Response,
    'twist_mux_msgs/action/JoyTurbo_Goal': twist_mux_msgs.action.JoyTurbo_Goal,
    'twist_mux_msgs/action/JoyTurbo_Result': twist_mux_msgs.action.JoyTurbo_Result,
    'twist_mux_msgs/action/JoyTurbo_SendGoal_Request': twist_mux_msgs.action.JoyTurbo_SendGoal_Request,
    'twist_mux_msgs/action/JoyTurbo_SendGoal_Response': twist_mux_msgs.action.JoyTurbo_SendGoal_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'ds4_driver_msgs/msg/Feedback': ds4_driver_msgs.msg.FeedbackConstructor,
    'ds4_driver_msgs/msg/Report': ds4_driver_msgs.msg.ReportConstructor,
    'ds4_driver_msgs/msg/Status': ds4_driver_msgs.msg.StatusConstructor,
    'ds4_driver_msgs/msg/Trackpad': ds4_driver_msgs.msg.TrackpadConstructor,
    ...
    'gazebo_model_attachment_plugin_msgs/srv/Attach_Request': gazebo_model_attachment_plugin_msgs.srv.Attach_RequestConstructor,
    'gazebo_model_attachment_plugin_msgs/srv/Attach_Response': gazebo_model_attachment_plugin_msgs.srv.Attach_ResponseConstructor,
    'gazebo_model_attachment_plugin_msgs/srv/Detach_Request': gazebo_model_attachment_plugin_msgs.srv.Detach_RequestConstructor,
    'gazebo_model_attachment_plugin_msgs/srv/Detach_Response': gazebo_model_attachment_plugin_msgs.srv.Detach_ResponseConstructor,
    ...
    'gazebo_msgs/msg/WheelSlip': gazebo_msgs.msg.WheelSlipConstructor,
    ...
    'gazebo_video_monitor_interfaces/msg/Pose': gazebo_video_monitor_interfaces.msg.PoseConstructor,
    'gazebo_video_monitor_interfaces/msg/Strings': gazebo_video_monitor_interfaces.msg.StringsConstructor,
    'gazebo_video_monitor_interfaces/srv/SetCamera_Request': gazebo_video_monitor_interfaces.srv.SetCamera_RequestConstructor,
    'gazebo_video_monitor_interfaces/srv/SetCamera_Response': gazebo_video_monitor_interfaces.srv.SetCamera_ResponseConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGmcmRecording_Request': gazebo_video_monitor_interfaces.srv.StartGmcmRecording_RequestConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGmcmRecording_Response': gazebo_video_monitor_interfaces.srv.StartGmcmRecording_ResponseConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGvmRecording_Request': gazebo_video_monitor_interfaces.srv.StartGvmRecording_RequestConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGvmRecording_Response': gazebo_video_monitor_interfaces.srv.StartGvmRecording_ResponseConstructor,
    'gazebo_video_monitor_interfaces/srv/StopRecording_Request': gazebo_video_monitor_interfaces.srv.StopRecording_RequestConstructor,
    'gazebo_video_monitor_interfaces/srv/StopRecording_Response': gazebo_video_monitor_interfaces.srv.StopRecording_ResponseConstructor,
    ...
    'orbbec_camera_msgs/msg/DeviceInfo': orbbec_camera_msgs.msg.DeviceInfoConstructor,
    'orbbec_camera_msgs/msg/Extrinsics': orbbec_camera_msgs.msg.ExtrinsicsConstructor,
    'orbbec_camera_msgs/msg/IMUInfo': orbbec_camera_msgs.msg.IMUInfoConstructor,
    'orbbec_camera_msgs/msg/Metadata': orbbec_camera_msgs.msg.MetadataConstructor,
    'orbbec_camera_msgs/srv/GetBool_Request': orbbec_camera_msgs.srv.GetBool_RequestConstructor,
    'orbbec_camera_msgs/srv/GetBool_Response': orbbec_camera_msgs.srv.GetBool_ResponseConstructor,
    'orbbec_camera_msgs/srv/GetCameraInfo_Request': orbbec_camera_msgs.srv.GetCameraInfo_RequestConstructor,
    'orbbec_camera_msgs/srv/GetCameraInfo_Response': orbbec_camera_msgs.srv.GetCameraInfo_ResponseConstructor,
    'orbbec_camera_msgs/srv/GetDeviceInfo_Request': orbbec_camera_msgs.srv.GetDeviceInfo_RequestConstructor,
    'orbbec_camera_msgs/srv/GetDeviceInfo_Response': orbbec_camera_msgs.srv.GetDeviceInfo_ResponseConstructor,
    'orbbec_camera_msgs/srv/GetInt32_Request': orbbec_camera_msgs.srv.GetInt32_RequestConstructor,
    'orbbec_camera_msgs/srv/GetInt32_Response': orbbec_camera_msgs.srv.GetInt32_ResponseConstructor,
    'orbbec_camera_msgs/srv/GetString_Request': orbbec_camera_msgs.srv.GetString_RequestConstructor,
    'orbbec_camera_msgs/srv/GetString_Response': orbbec_camera_msgs.srv.GetString_ResponseConstructor,
    'orbbec_camera_msgs/srv/SetInt32_Request': orbbec_camera_msgs.srv.SetInt32_RequestConstructor,
    'orbbec_camera_msgs/srv/SetInt32_Response': orbbec_camera_msgs.srv.SetInt32_ResponseConstructor,
    'orbbec_camera_msgs/srv/SetString_Request': orbbec_camera_msgs.srv.SetString_RequestConstructor,
    'orbbec_camera_msgs/srv/SetString_Response': orbbec_camera_msgs.srv.SetString_ResponseConstructor,
    ...
    'realsense2_camera_msgs/action/TriggeredCalibration_Feedback': realsense2_camera_msgs.action.TriggeredCalibration_FeedbackConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_FeedbackMessage': realsense2_camera_msgs.action.TriggeredCalibration_FeedbackMessageConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_GetResult_Request': realsense2_camera_msgs.action.TriggeredCalibration_GetResult_RequestConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_GetResult_Response': realsense2_camera_msgs.action.TriggeredCalibration_GetResult_ResponseConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_Goal': realsense2_camera_msgs.action.TriggeredCalibration_GoalConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_Result': realsense2_camera_msgs.action.TriggeredCalibration_ResultConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_SendGoal_Request': realsense2_camera_msgs.action.TriggeredCalibration_SendGoal_RequestConstructor,
    'realsense2_camera_msgs/action/TriggeredCalibration_SendGoal_Response': realsense2_camera_msgs.action.TriggeredCalibration_SendGoal_ResponseConstructor,
    ...
    'realsense2_camera_msgs/srv/CalibConfigRead_Request': realsense2_camera_msgs.srv.CalibConfigRead_RequestConstructor,
    'realsense2_camera_msgs/srv/CalibConfigRead_Response': realsense2_camera_msgs.srv.CalibConfigRead_ResponseConstructor,
    'realsense2_camera_msgs/srv/CalibConfigWrite_Request': realsense2_camera_msgs.srv.CalibConfigWrite_RequestConstructor,
    'realsense2_camera_msgs/srv/CalibConfigWrite_Response': realsense2_camera_msgs.srv.CalibConfigWrite_ResponseConstructor,
    ...
    'ros_gz_interfaces/msg/EntityWrench': ros_gz_interfaces.msg.EntityWrenchConstructor,
    ...
    'slam_toolbox/srv/AddSubmap_Request': slam_toolbox.srv.AddSubmap_RequestConstructor,
    'slam_toolbox/srv/AddSubmap_Response': slam_toolbox.srv.AddSubmap_ResponseConstructor,
    'slam_toolbox/srv/ClearQueue_Request': slam_toolbox.srv.ClearQueue_RequestConstructor,
    'slam_toolbox/srv/ClearQueue_Response': slam_toolbox.srv.ClearQueue_ResponseConstructor,
    'slam_toolbox/srv/Clear_Request': slam_toolbox.srv.Clear_RequestConstructor,
    'slam_toolbox/srv/Clear_Response': slam_toolbox.srv.Clear_ResponseConstructor,
    'slam_toolbox/srv/DeserializePoseGraph_Request': slam_toolbox.srv.DeserializePoseGraph_RequestConstructor,
    'slam_toolbox/srv/DeserializePoseGraph_Response': slam_toolbox.srv.DeserializePoseGraph_ResponseConstructor,
    'slam_toolbox/srv/LoopClosure_Request': slam_toolbox.srv.LoopClosure_RequestConstructor,
    'slam_toolbox/srv/LoopClosure_Response': slam_toolbox.srv.LoopClosure_ResponseConstructor,
    'slam_toolbox/srv/MergeMaps_Request': slam_toolbox.srv.MergeMaps_RequestConstructor,
    'slam_toolbox/srv/MergeMaps_Response': slam_toolbox.srv.MergeMaps_ResponseConstructor,
    'slam_toolbox/srv/Pause_Request': slam_toolbox.srv.Pause_RequestConstructor,
    'slam_toolbox/srv/Pause_Response': slam_toolbox.srv.Pause_ResponseConstructor,
    'slam_toolbox/srv/SaveMap_Request': slam_toolbox.srv.SaveMap_RequestConstructor,
    'slam_toolbox/srv/SaveMap_Response': slam_toolbox.srv.SaveMap_ResponseConstructor,
    'slam_toolbox/srv/SerializePoseGraph_Request': slam_toolbox.srv.SerializePoseGraph_RequestConstructor,
    'slam_toolbox/srv/SerializePoseGraph_Response': slam_toolbox.srv.SerializePoseGraph_ResponseConstructor,
    'slam_toolbox/srv/ToggleInteractive_Request': slam_toolbox.srv.ToggleInteractive_RequestConstructor,
    'slam_toolbox/srv/ToggleInteractive_Response': slam_toolbox.srv.ToggleInteractive_ResponseConstructor,
    ...
    'turtlebot3_msgs/srv/Goal_Request': turtlebot3_msgs.srv.Goal_RequestConstructor,
    'turtlebot3_msgs/srv/Goal_Response': turtlebot3_msgs.srv.Goal_ResponseConstructor,
    ...
    'twist_mux_msgs/action/JoyPriority_Feedback': twist_mux_msgs.action.JoyPriority_FeedbackConstructor,
    'twist_mux_msgs/action/JoyPriority_FeedbackMessage': twist_mux_msgs.action.JoyPriority_FeedbackMessageConstructor,
    'twist_mux_msgs/action/JoyPriority_GetResult_Request': twist_mux_msgs.action.JoyPriority_GetResult_RequestConstructor,
    'twist_mux_msgs/action/JoyPriority_GetResult_Response': twist_mux_msgs.action.JoyPriority_GetResult_ResponseConstructor,
    'twist_mux_msgs/action/JoyPriority_Goal': twist_mux_msgs.action.JoyPriority_GoalConstructor,
    'twist_mux_msgs/action/JoyPriority_Result': twist_mux_msgs.action.JoyPriority_ResultConstructor,
    'twist_mux_msgs/action/JoyPriority_SendGoal_Request': twist_mux_msgs.action.JoyPriority_SendGoal_RequestConstructor,
    'twist_mux_msgs/action/JoyPriority_SendGoal_Response': twist_mux_msgs.action.JoyPriority_SendGoal_ResponseConstructor,
    'twist_mux_msgs/action/JoyTurbo_Feedback': twist_mux_msgs.action.JoyTurbo_FeedbackConstructor,
    'twist_mux_msgs/action/JoyTurbo_FeedbackMessage': twist_mux_msgs.action.JoyTurbo_FeedbackMessageConstructor,
    'twist_mux_msgs/action/JoyTurbo_GetResult_Request': twist_mux_msgs.action.JoyTurbo_GetResult_RequestConstructor,
    'twist_mux_msgs/action/JoyTurbo_GetResult_Response': twist_mux_msgs.action.JoyTurbo_GetResult_ResponseConstructor,
    'twist_mux_msgs/action/JoyTurbo_Goal': twist_mux_msgs.action.JoyTurbo_GoalConstructor,
    'twist_mux_msgs/action/JoyTurbo_Result': twist_mux_msgs.action.JoyTurbo_ResultConstructor,
    'twist_mux_msgs/action/JoyTurbo_SendGoal_Request': twist_mux_msgs.action.JoyTurbo_SendGoal_RequestConstructor,
    'twist_mux_msgs/action/JoyTurbo_SendGoal_Response': twist_mux_msgs.action.JoyTurbo_SendGoal_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'gazebo_model_attachment_plugin_msgs/srv/Attach': gazebo_model_attachment_plugin_msgs.srv.AttachConstructor,
    'gazebo_model_attachment_plugin_msgs/srv/Detach': gazebo_model_attachment_plugin_msgs.srv.DetachConstructor,
    ...
    'gazebo_video_monitor_interfaces/srv/SetCamera': gazebo_video_monitor_interfaces.srv.SetCameraConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGmcmRecording': gazebo_video_monitor_interfaces.srv.StartGmcmRecordingConstructor,
    'gazebo_video_monitor_interfaces/srv/StartGvmRecording': gazebo_video_monitor_interfaces.srv.StartGvmRecordingConstructor,
    'gazebo_video_monitor_interfaces/srv/StopRecording': gazebo_video_monitor_interfaces.srv.StopRecordingConstructor,
    ...
    'orbbec_camera_msgs/srv/GetBool': orbbec_camera_msgs.srv.GetBoolConstructor,
    'orbbec_camera_msgs/srv/GetCameraInfo': orbbec_camera_msgs.srv.GetCameraInfoConstructor,
    'orbbec_camera_msgs/srv/GetDeviceInfo': orbbec_camera_msgs.srv.GetDeviceInfoConstructor,
    'orbbec_camera_msgs/srv/GetInt32': orbbec_camera_msgs.srv.GetInt32Constructor,
    'orbbec_camera_msgs/srv/GetString': orbbec_camera_msgs.srv.GetStringConstructor,
    'orbbec_camera_msgs/srv/SetInt32': orbbec_camera_msgs.srv.SetInt32Constructor,
    'orbbec_camera_msgs/srv/SetString': orbbec_camera_msgs.srv.SetStringConstructor,
    ...
    'realsense2_camera_msgs/srv/CalibConfigRead': realsense2_camera_msgs.srv.CalibConfigReadConstructor,
    'realsense2_camera_msgs/srv/CalibConfigWrite': realsense2_camera_msgs.srv.CalibConfigWriteConstructor,
    ...
    'slam_toolbox/srv/AddSubmap': slam_toolbox.srv.AddSubmapConstructor,
    'slam_toolbox/srv/Clear': slam_toolbox.srv.ClearConstructor,
    'slam_toolbox/srv/ClearQueue': slam_toolbox.srv.ClearQueueConstructor,
    'slam_toolbox/srv/DeserializePoseGraph': slam_toolbox.srv.DeserializePoseGraphConstructor,
    'slam_toolbox/srv/LoopClosure': slam_toolbox.srv.LoopClosureConstructor,
    'slam_toolbox/srv/MergeMaps': slam_toolbox.srv.MergeMapsConstructor,
    'slam_toolbox/srv/Pause': slam_toolbox.srv.PauseConstructor,
    'slam_toolbox/srv/SaveMap': slam_toolbox.srv.SaveMapConstructor,
    'slam_toolbox/srv/SerializePoseGraph': slam_toolbox.srv.SerializePoseGraphConstructor,
    'slam_toolbox/srv/ToggleInteractive': slam_toolbox.srv.ToggleInteractiveConstructor,
    ...
    'turtlebot3_msgs/srv/Goal': turtlebot3_msgs.srv.GoalConstructor,
  ...
  type ActionsMap = {
    ...
    'realsense2_camera_msgs/action/TriggeredCalibration': realsense2_camera_msgs.action.TriggeredCalibrationConstructor,
    ...
    'twist_mux_msgs/action/JoyPriority': twist_mux_msgs.action.JoyPriorityConstructor,
    'twist_mux_msgs/action/JoyTurbo': twist_mux_msgs.action.JoyTurboConstructor,
  };
